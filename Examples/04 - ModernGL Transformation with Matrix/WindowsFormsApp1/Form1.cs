    ...
    public partial class Form1 : Form
    {
        ...
        private void loop()
        {
            ...
            while (true) {
                ...
                //Transform the Projection and Modelview Matrix
                ...
                //Send the matrix data to the shader. This are custom functions within NetGL
                //to increase the performance.
                gl.SetProjectionMatrix(gl.GetUniformLocation(program, "projMatrix"), 1, false);
                gl.SetModelviewMatrix(gl.GetUniformLocation(program, "modelMatrix"), 1, false);
